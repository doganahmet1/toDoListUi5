sap.ui.define([
	...
	"use strict";
	return Controller.extend("todolistZHCM_UX_TODO_ODEV.controller.TodoList", {
		onInit: function() {
			this._InitialView();
		},
		onPressAddTask: function(oEvent) {
			if (!this._oCreateDialog) {
				this._oCreateDialog = sap.ui.xmlfragment("todolistZHCM_UX_TODO_ODEV.fragment.CreateTodo", this);
